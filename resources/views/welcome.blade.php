...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Styles -->
        <style>
            /* ! tailwindcss v3.4.1 | MIT License | https://tailwindcss.com */*,::after,::before{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}::after,::before{--tw-content:''}:host,
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6">
                            <div>
                                <h1 class="text-center">Gerenciador de Tasks</h5>
                            </div>
                        </div>
                        ...
                        <div class="mt-5 col-md-9 mx-auto text-white">
                            ...
                            <p>
                                Esta é um projeto <code>laravel</code> e <code>vue</code>. Aqui você gerencia todo o processo de cadastro, listagem, edição e exclusão de tasks.<br>
